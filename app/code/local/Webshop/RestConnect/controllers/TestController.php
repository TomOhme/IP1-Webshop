...
class Webshop_RestConnect_TestController extends Mage_Core_Controller_Front_Action {
    ...
    public function indexAction() {
        ...
        //on Magento
        $params = array(
            'siteUrl' => 'http://127.0.0.1/magento/index.php/oauth',
            'requestTokenUrl' => 'http://127.0.0.1/magento/index.php/oauth/initiate',
            'accessTokenUrl' => 'http://127.0.0.1/magento/index.php/oauth/token',
            'authorizeUrl' => 'http://127.0.0.1/magento/index.php/admin/oAuth_authorize', //This URL is used only if we authenticate as Admin user type
            ...
            'callbackUrl' => 'http://127.0.0.1/magento/index.php/restconnect/test/callback', //Url of callback action below
        );
